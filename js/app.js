...
.config(function($stateProvider, $urlRouterProvider) {
 ...
 .state('new', {
	...
	.state('paymeClaim', {
      url: '/paymeClaim',
          templateUrl: 'templates/fsa/paymeClaim.html',
		  controller: 'paymeClaimCtrl'
    })
	.state('payproviderClaim', {
      url: '/payproviderClaim',
          templateUrl: 'templates/fsa/payproviderClaim.html',
		  controller: 'payproviderClaimCtrl'
    })
